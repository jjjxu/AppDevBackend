...
def update_single_class(course_subj, course_code):
    semester = 'FA21'
    # pull data from online
    dept_class = requests.get("https://classes.cornell.edu/api/2.0/search/classes.json", params={"roster": semester, "subject": course_subj})
    ...
    for each_class in json_classes['data']['classes']:
        ...
        if class_CURover == -1 and class_CURdiff == -1 and class_CURwork == -1:
            return failure_response("CUReviews failed to load")
